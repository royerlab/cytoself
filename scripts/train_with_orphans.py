...
# results_dir = Path("results/20231218_train_all_no_nucdist_balanced_classes_2")
results_dir = Path("results/20231221_train_with_orphans")

results_dir.mkdir(exist_ok=True)
tensorboard_path = "logs"
sampling_strategy = None  # this does balanced sampling

# 1. Prepare Data
# data_ch = ['pro', 'nuc', 'nucdist'] # ['pro', 'nuc', 'nucdist']
data_ch = ['pro', 'nuc', 'nucdist']  #  

datapath = Path("data/opencell_crops_proteins_plus_orphans")
