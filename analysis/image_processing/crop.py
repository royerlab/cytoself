...
and height. The crop has the protein in ch0 and protein in ch1. They are saved to 
inference/results/crop/


Optionally add a check that there is protein signal in the crop. 
"""
