...
with open(path.join(path.abspath(path.dirname(__file__)), "README.md"), "r", encoding="utf-8") as fh:
    long_description = fh.read()

with open(path.join(path.abspath(path.dirname(__file__)), "requirements", "requirements.txt")) as f:
    default_requirements = [line.strip() for line in f if line and not line.startswith("#")]
